...
#   additive-change       stg_orders: add order_day column (should be LOW risk)
#   custom <file> <heredoc-file>   overwrite <file> with contents of <heredoc-file>
#
# Examples:
#   ./test-pr-guardian-e2e.sh renamed-column
#   ./test-pr-guardian-e2e.sh additive-change --merge
#   ./test-pr-guardian-e2e.sh custom pr-guardian-demo/models/marts/fct_revenue.sql my_new_model.sql --merge
...
# ---------------------------------------------------------------------------
# Step 2: apply the edit for the chosen scenario
# ---------------------------------------------------------------------------
COMMIT_MSG=""
PR_TITLE=""
PR_BODY=""
...
EOF
    ...
    PR_TITLE="Test: additive change (expect LOW risk)"
    PR_BODY="Automated PR Guardian test. Expect a LOW severity comment, not a skip."
    ;;
...
# ---------------------------------------------------------------------------
# Step 5: watch the analyze workflow run for this PR's head commit
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Step 6: print the guardian's PR comment
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Step 7 (optional): merge, then watch the writeback workflow
# ---------------------------------------------------------------------------
